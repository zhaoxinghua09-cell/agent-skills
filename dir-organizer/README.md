...
> `dir-organizer` v1.0.0 · LGD-Powered Utility Family · Zero-dependency

**中文**：下载夹几百个文件混在一起，找东西全靠搜，归类又懒得手动拖 一条命令搞定；默认 dry-run 预览、`--apply` 才执行、`--json` 机器可读；成功 rc=0 / 发现问题 rc=1 / 用法错误 rc=2。
