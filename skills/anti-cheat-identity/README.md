...
## What it does
Classifies `anti-cheat-identity` per UIBC rules: **UIBC 反作弊规范 + 通用学术诚信原则**.

## Install & run (zero-dependency, Python 3.8+)
```bash
python anti-cheat-identity.py --demo
```
...
## Compliance & IP
- LGD-Powered badge · theory TH-EVT-004 · ambassador 诺卫@UAS/安全域首席发声人
