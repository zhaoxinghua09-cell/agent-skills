...
> `text-replace` v1.0.0 · LGD-Powered Utility Family · Zero-dependency

**中文**：改名/改版本号/改接口地址，几十个文件一个个开编辑器改到眼瞎 一条命令搞定；默认 dry-run 预览、`--apply` 才执行、`--json` 机器可读；成功 rc=0 / 发现问题 rc=1 / 用法错误 rc=2。
