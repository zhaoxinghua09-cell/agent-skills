...
- 规则源：`GB/T 40429-2021《汽车驾驶自动化分级》表1`（以官方最新文本为准）。

## 三、用法
```bash
python aut-grade-checker.py --mtow 5          # 按参数判定
python aut-grade-checker.py --demo            # 跑内置冒烟案例
```
参数：`dd / oedr / odd_limited / takeover_needed / both_axes`

## 四、真机输出（--demo 节选）
```json
{"tool":"aut-grade-checker","result":{"grade":"示例等级"},"rc":0}
```
