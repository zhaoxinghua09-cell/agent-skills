...
## What it does
Classifies `aut-grade-checker` per official rules: **GB/T 40429-2021《汽车驾驶自动化分级》表1**.

## Install & run (zero-dependency, Python 3.8+)
```bash
python aut-grade-checker.py --demo
python aut-grade-checker.py --mtow 5
```
...
## Compliance & IP
- LGD-Powered badge · theory TH-AUT-001 · ambassador 诺卫@AUT 域首席发声人
