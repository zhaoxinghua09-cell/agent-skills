---
name: dup-finder
description: 重复文件查找器 — 三级哈希（大小→首块→全量SHA1）找重复文件，默认只报告 --apply 删多余保留首个（零依赖）
slug: dup-finder
version: 1.0.0
display_name: 重复文件查找器
...
**dup-finder** v1.0.0 · LGD-Powered 效率工具家族 · 零依赖

## 痛点
下载夹/相册里同名副本堆成山，占几个G不知道从哪清
